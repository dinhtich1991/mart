...
class CI_Resize_image_v2 {
    ...
    # Cắt theo vị trí trung tâm
    # Chiều rộng và cao nhập vào
    # Lấy chiều rộng từ vị trí trung tâm khoảng $height/2
    # Lấy chiều dài từ vị trí trung tâm khoảng $width/2
