...
class Antispam {
    ...
    */
    ...
    var $img_width   = 100;    // CODE_WIDTH
    var $img_height  = 40;  // CODE_HEIGHT	
    var $font_name   = "UTMBebas.ttf";  // test.ttf
    var $font_path   = 'fonts/UTMBebas';  // PATH_TTF	
    ...
    var $char_length = 6;  // CODE_CHARS_COUNT
    ...
    var $expiration  = 100; // Thời gian xóa hình cũ
